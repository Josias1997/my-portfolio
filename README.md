...
This portfolio starter pack is made using React. The data on the portfolio is directly linked to a JSON files (French and English). Any changes to the portfolio can be made in the JSON files. The changes will then be reflected on to the portfolio. This allows you to customize your own personal portfolio that can be used for applying to jobs or other personal uses.
...
```git clone https://github.com/Josias1997/my-portfolio.git```
